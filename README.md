...
### 💻 About This Project
**A4 Assignment Four** is one of my web development assignments. It showcases my ability to translate design requirements into a pixel-perfect, responsive frontend layout using pure **HTML5** and **CSS3** (Flexbox/Grid).
